_bgd_function(function(){
    ...
    // block advertisement.
    document.getElementsByClassName('is_mb')[0].style.display = 'none';
    document.getElementsByClassName('is_mb')[1].style.display = 'none';
    document.getElementsByClassName('is_mb')[2].style.display = 'none';
    document.getElementsByClassName('is_mb')[3].style.display = 'none';
